...
Relationships are **declared, not auto-detected**. Nothing tries to infer who a line is addressed to: an addressee resolver that guesses wrong is wrong silently and everywhere. The declared table goes in the prompt alongside the scene, and the translator applies it.
